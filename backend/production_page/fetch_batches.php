...
// TABLE GENERATOR IN PRODUCTION PAGE
...
try {
    ...
    while ($row = $batches->fetch_assoc()):
        ...
        while ($mat = $materials_res->fetch_assoc()) {
            ...
            // Add material to array (no freshness)
            $materials[] = [
        ...
        <tr>
            ...
            <td>
                ...
                if (!empty($materials)) {
                    foreach ($materials as $m) {
                        if ($row['status'] === 'scheduled') {
                            echo "<span style='font-family:Poppins,sans-serif;'>"
                                . htmlspecialchars($m['name'])
                                . ": Reserved (<b style='color:orange'>" . htmlspecialchars($m['needed']) . "</b>)"
                                . "</span><br>";
                        } elseif ($row['status'] === 'in_progress') {
                            echo "<span style='font-family:Poppins,sans-serif;'>"
                                . htmlspecialchars($m['name'])
                                . ": Used (<b style='color:green'>" . htmlspecialchars($m['needed']) . "</b>)</span><br>";
                        } else {
